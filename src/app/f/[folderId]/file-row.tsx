    ...
    <li key={file.id} className="px-6 py-4 border-b border-gray-700 hover:bg-gray-750">
                <div className="grid grid-cols-12 gap-4 items-center">
                  <div className="col-span-6 flex items-center">
                      <a href={file.url} className="flex items-center text-gray-100 hover:text-blue-400"
                      target="_blank"
                      >
                  ...
                  <div className="col-span-1 text-gray-400"><Button variant={"ghost"} onClick={() => deleteFile(file.id)}aria-label="Delete File"><Trash2Icon  size={20}></Trash2Icon></Button></div>
                </div>
              </li>
  )
}
